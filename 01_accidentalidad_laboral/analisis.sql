...
-- Fórmula: (N° de accidentes en el mes / N° de trabajadores) * 100
-- Nota: Se excluyen los "Cuasi-accidente" si solo se evalúan accidentes reales.
-- =========================================================================
SELECT
    i.area,
...
ORDER BY frecuencia_accidentalidad DESC;


-- =========================================================================
-- 2. SEVERIDAD DE ACCIDENTALIDAD (CORREGIDO)
-- Fórmula: ((Días incapacidad + Días cargados) / N° de trabajadores) * 100
-- =========================================================================
SELECT 
    i.area, 
    DATE_FORMAT(i.fecha, '%Y-%m-01') AS mes, 
    SUM(i.dias_incapacidad + i.dias_cargados) AS total_dias_perdidos, 
    t.num_trabajadores, 
